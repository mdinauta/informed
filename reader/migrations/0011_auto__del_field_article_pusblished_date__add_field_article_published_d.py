...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.pusblished_date'
        db.delete_column(u'reader_article', 'pusblished_date')

        # Adding field 'Article.published_date'
        db.add_column(u'reader_article', 'published_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Article.pusblished_date'
        db.add_column(u'reader_article', 'pusblished_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 7, 25, 0, 0)),
                      keep_default=False)

        # Deleting field 'Article.published_date'
        db.delete_column(u'reader_article', 'published_date')
