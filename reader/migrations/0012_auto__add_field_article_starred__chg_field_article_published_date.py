...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'reader_article', 'starred',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Article.published_date'
        db.alter_column(u'reader_article', 'published_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 5, 0, 0)))

    def backwards(self, orm):
        # Deleting field 'Article.starred'
        db.delete_column(u'reader_article', 'starred')


        # Changing field 'Article.published_date'
        db.alter_column(u'reader_article', 'published_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
